  ...
  if ($scope.alerts.length == 0){
    ...
    var progressSubmissionStatus = function(msg){
      ...
      if ($scope.submitProgress >= 99){
        ...
        $scope.description = "";
        $scope.alerts.length = 0;
        $scope.alerts.push({ type: 'success', msg: 'Submission Successful! Thank-you for contributing to public safety. Feel free to add another submission, <a ng-click="redirect(\'ObservationViewMap\')">view submissions</a> or <a ng-click="redirect(\'Map\')">view forecasts.</a>' });
      }
    }
